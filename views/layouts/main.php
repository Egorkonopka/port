                ...
                <div class="row">
                    <div class="col-md-4 clearfix">
                        <div class="logo pull-left">
                            <a href="<?= \yii\helpers\Url::home()?>"><?= Html::img('@web/images/home/logot.jpg', ['alt' => 'E-SHOPPER'])?></a>
                        </div>
                    </div>
...
<?php endif;?>
                                <li><a href="<?= Url::to(['category/dislocation']) ?>"><i class="fa fa-crosshairs"></i>To Go</a></li>
